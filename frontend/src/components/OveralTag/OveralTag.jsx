...
const OveralTag = (props) => {
    return(
        <div style={{width: '747px', height: '340px', position: 'relative', marginTop: '40px'}}>
            <div className="linear-bg">
                ...
                <p style={{fontSize: '60px', fontWeight: '650'}}>{props.value}</p>
                {
                    ...
                    TagData.map(infor => (
                        infor.id === 1 ?
                        <div style={{ width: 'fit-content', position: 'absolute', bottom: '20%'}}>
                            <InformationTag title={infor.title} value={infor.value}/>
                        </div> 
                        : 
                        <div style={{ width: 'fit-content', position: 'absolute', bottom: '20%', left: '30%'}}>
                        <InformationTag title={infor.title} value={infor.value}/>
                    </div>
                    )) : null
                }
                <div style={{position: 'absolute', right: '1%', bottom: '9.8%'}}>
                    <img src={doctorimg}/>;
                </div>
            </div>
        </div>
